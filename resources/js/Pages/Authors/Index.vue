...
import SelectInpit from '@/Components/SelectInpit.vue'
...
const closeModalvuiew =()=>{
    showModalVie.value =false;
}
...
<template>
    ...
    <template #header>
        ...
        Authors    
        <DarkButton @click="openModalForm(1,a)"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<div class="inline-flex overflow-hidden mb-4 w-full bg-white rounded-lg shadow-md" :class="classMsj">
      ...
      <div class="w-full overflow-x-auto bg-white">
        <table class="w-full whitespace-no-wrap">
            ...
            <tbody class="bg-white divide-y divide-gray-700 bg-gray-800">
             ...
             <td class="px-4 py-3 texr-sm">
               <SecondaryButton @click="openModalView(a)"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
             ...
             <td class="px-4 py-3 texr-sm">
               <WarninButton  @click="openModalForm(2,a)"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
</svg>
</WarninButton>
             </td>
             <td class="px-4 py-3 texr-sm">
               <DangerButton  @click="openModalDel(a)"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 9.75 14.25 12m0 0 2.25 2.25M14.25 12l2.25-2.25M14.25 12 12 14.25m-2.58 4.92-6.374-6.375a1.125 1.125 0 0 1 0-1.59L9.42 4.83c.21-.211.497-.33.795-.33H19.5a2.25 2.25 0 0 1 2.25 2.25v10.5a2.25 2.25 0 0 1-2.25 2.25h-9.284c-.298 0-.585-.119-.795-.33Z" />
    ...
    <Modal :show="showModalVie" @close="closeModalvuiew">
        ...
        <SecondaryButton @click="closeModalvuiew" >Cancel</SecondaryButton>
    </Modal>
    <Modal :show="showModalForm" @close="closeModalForm">
      
        <div class="p-6">
            <h2 class="text-lg font-medium text-gray-900"> {{ title }}</h2>
            <div class="mt-6 mb-6 space-y-6 masx-w-xl">
    ...
    <Modal :show="showModalDel" @close="closeModalDel">
        ...
        <div class="p-6">
            ...
            <p class="text-2xl text-gray-500">
                ...
                <PrimaryButton @click="deleteAhotor">yes, delete</PrimaryButton>
